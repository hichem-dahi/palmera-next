<template>
  <v-card :title="title || $t('create-client')" class="pa-4">
    ...
    <v-text-field
      ...
      :error-messages="
        !$v.address.$pending && $v.address.$dirty
          ? [
    ...
    <v-text-field
      ...
      :error-messages="
        !$v.activity.$pending && $v.activity.$dirty
